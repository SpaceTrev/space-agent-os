...
function UserMenu() {
  ...
  if (loading) return <div className="w-6 h-6 rounded-full bg-white/10 animate-pulse" />
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        <div className="w-6 h-6 rounded-full bg-sky-600 flex items-center justify-center text-[10px] font-bold text-white select-none">
          {initials}
        </div>
        ...
        <div className="absolute right-0 mt-2 w-52 rounded-xl border border-white/[0.08] bg-[#0f1117] shadow-2xl z-50 overflow-hidden">
          ...
          <div className="py-1">
            <button
              ...
              className="w-full flex items-center gap-2.5 px-4 py-2.5 text-[12px] text-white/60 hover:text-white hover:bg-white/[0.05] transition-colors"
            >
