      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface-base border border-outline-variant rounded-2xl p-8 shadow-2xl">
          <div className="mb-6 text-center">
            ...
            <p className="text-sm text-on-surface-variant mt-1">Start deploying AI agents in minutes</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-on-surface-variant text-center">
              ...
              <Link href="#" className="text-on-surface-variant hover:text-on-surface">Terms of Service</Link>
              {' '}and{' '}
              <Link href="#" className="text-on-surface-variant hover:text-on-surface">Privacy Policy</Link>
            </p>
