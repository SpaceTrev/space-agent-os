    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-[var(--on-surface)] line-clamp-2">{title}</p>
          {description && (
            <p className="text-xs text-[var(--on-surface-variant)] mt-1 line-clamp-1">{description}</p>
          )}
        </div>
